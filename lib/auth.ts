...
export const COOKIE_SESSAO = "sacrazen_painel";

const SENHA_LOCAL = process.env.PAINEL_SENHA_LOCAL ?? "sacrazen";
const SEGREDO = process.env.PAINEL_SEGREDO ?? "sacrazen-desenvolvimento";
